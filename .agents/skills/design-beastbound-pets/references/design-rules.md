...
At capture, show Lv1 4V and stable visible identity. During training, show evidence from actual growth and an estimate that becomes more useful around Lv20. Keep exact seed, hidden quality, and authoritative future roll GM-only.
