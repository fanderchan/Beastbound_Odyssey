...
| 排查当前静止性能问题 | [人物排序优化与分项耗时](phase_600_retained_actor_depth_state.md)、[最近完整四层矩阵](phase_599_performance_cleanup_rendering.md)、[静止按需绘制](phase_598_world_idle_rendering.md) |
