...
> 后续纠正（Phase 453）：本阶段把人物敌方 `front_3quarter_sw` 误判为已经朝向右下，
> 与同侧正式宠物的最终几何相矛盾。当前权威合同已改为敌我双方人物均在战斗展示层水平翻转；
> 详见 `docs/phase_453_battle_character_facing_regression.md`。本文件保留当时过程与证据，不再作为
> 当前人物朝向规则来源。
