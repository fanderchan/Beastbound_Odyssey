...
4. **依次推进成品门槛**：继续 R1.W025；[Phase604](phase_604_battle_outcome_lifecycle.md)～[Phase606](phase_606_world_marker_player_visibility.md) 已修复旧奖励残留、双台名称混淆和名称挡人，[Phase607](phase_607_cave_review_and_capture_capacity.md) 完成四层／地标审片与返程关键帧复核，并修复捕捉容量提示的误显示和布局。[Phase608](phase_608_current_cave_evidence_refreeze.md) 已完成最终源码的 20 组画面／动作、48 组性能与碰撞证据冻结；接着补齐同版本影片及成功返程，再推进剩余视听验收、首发内容、玩法／经济、运营基础设施、正式构建和封测。
...
| 四层路线与五人守护战 | Phase602 完成当前后端四层鼠标往返，Phase603 完成守护与两场普通遭遇全胜返村；[Phase607](phase_607_cave_review_and_capture_capacity.md) 新一轮守护与前三场普通遭遇胜利，第四场战败后正常逐层返村，100 次回合完整播放 | 最新长流程严格全胜门为 FAIL；高生命 QA 与关键帧审查不替代正常难度、五真人联机或所有者接受；Phase608 已配齐地图画面／动作／性能，当前版本完整影片与成功战斗返村仍待完成 |
...
**接下来的顺序**：R1.W024 已完成，R1.W025 继续。Phase608 已为 `e9d93013…` 最终代码安装 20 组画面／真实鼠标动作、48 组原生性能和严格碰撞报告，整包审计恢复 `errors=[]`；原 176 个候选文件先完整备份，两次鼠标会话的暂停边界如实保留。接着补当前版本四层／地标影片及守护战、普通遭遇全胜返村，Phase607 四胜一败原件保持。地面重复、细节偏稀仍是品质限制，测试与内部审查不代表老板美术接受或正式发布，见 [Phase608](phase_608_current_cave_evidence_refreeze.md)。
