...
- [ ] **R1.W024 AUTO｜Earth Vein 录片资源收口与精确证据重冻**
  ...
  人物轮廓复用（2026-09-19）：Phase 575 以四层网格／美术调用对照定位重复轮廓查询，复用动作键及局部矩形，始终应用当前世界变换；962 次对照一致、定向 `5/5`，12 组 headless 静止完整脚本中位数约减少 7.4%，移动基本持平，六组跨帧点击全部正确。原生前 32 组有效，第 33 组因 5 帧失焦拒绝整批，33 个 Main 与 lane 全部回收；111 项保护文件不变，完整性能与精确证据继续待办，本项不勾选。
