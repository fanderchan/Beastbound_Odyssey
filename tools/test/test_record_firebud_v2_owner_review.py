...
def _capture_report(*, map_id: str, mode: str) -> dict:
    return {
        ...
        "cameraComposition": {
            ...
            "playerAlphaScreenRect": [356.0, 224.0, 68.0, 136.0],
            ...
            "worldSubjectScale": {
                "playerHeightPx": 136.0,
                "npcMedianHeightPx": 136.0,
                "playerToNpcHeightRatio": 1.0,
                "targetHeightRangePx": [120.0, 150.0],
                "targetRatioRange": [0.88, 1.12],
                "passed": True,
            },
    ...
    def test_capture_report_rejects_hud_occlusion_and_cropped_gate_landmark(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            invalid_cases = (
                ...
                ("playerAlphaBoundsSource", "fallback_interaction_probe"),
                ("playerAlphaInsideSafeRect", False),
                ("playerAlphaClearOfTaskHud", False),
                ("playerAlphaClearOfFixedHud", False),
                ("playerAlphaViewportEdgeClear", False),
                ("playerAlphaScreenRect", [356.0, 224.0, 68.0, 96.0]),
                ("worldSubjectScale", {"passed": False}),
